...
namespace Ethereum\Web3;

use Ethereum\Web3\Eth;
use Ethereum\Web3\Net;
use Ethereum\Web3\Personal;
use Ethereum\Web3\Shh;
...
class Web3
{
     ...
     * provider
     *
     * @var \Ethereum\Web3\Providers\Provider
     */
    protected $provider;
     ...
     * construct
     *
     * @param string|\Ethereum\Web3\Providers\Provider $provider
     * @param float $timeout
     * @return void
     */
    ...
    public function __call($name, $arguments)
    {
        ...
        if (preg_match('/^[a-zA-Z0-9]+$/', $name) === 1) {
            ...
            if (!array_key_exists($method, $this->methods)) {
                // new the method
                $methodClass = sprintf("\Web3\Methods\%s\%s", ucfirst($class[2]), ucfirst($name));
     ...
     * getProvider
     * 
     * @return \Ethereum\Web3\Providers\Provider
     */
     ...
     * setProvider
     * 
     * @param \Ethereum\Web3\Providers\Provider $provider
     * @return bool
     */
